...
public class ScoreCardA extends AScoreCard{
    ...
    public int SalmonScoreCard(Tile[][] matrix, ArrayList<Tile> playerTiles)
    {
        ...
        {
            if(t.finalHabitat != null && t.finalHabitat.getToken() == HabitatToken.ELK && !alreadyCountedTiles.contains(t))
            {
                ...
                if(matrix[x+1][y].finalHabitat != null && matrix[x+1][y].finalHabitat.getToken() == HabitatToken.SALMON && !alreadyCountedTiles.contains(t))
                {
                    while(matrix[x+1][y].finalHabitat != null && matrix[x+1][y].finalHabitat.getToken() == HabitatToken.SALMON && !alreadyCountedTiles.contains(t))
                    {
                ...
                if(matrix[x][y+1].finalHabitat != null && matrix[x][y+1].finalHabitat.getToken() == HabitatToken.SALMON && !alreadyCountedTiles.contains(t))
                {
                    while(matrix[x][y+1].finalHabitat != null && matrix[x][y+1].finalHabitat.getToken() == HabitatToken.SALMON && !alreadyCountedTiles.contains(t))
                    {
        ...
        {
            if(run == 0) score += 0;
            else if(run == 1) score += 2;
            else if(run == 2) score += 4;
            else if(run == 3) score += 7;
            else if(run == 4) score += 11;
            else if(run == 5) score += 15;
            else if(run == 6) score += 20;
            else score += 26;
        }
        return score;
    }
    ...
    public int ElkScoreCard(Tile[][] matrix, ArrayList<Tile> playerTiles)
    {
        ...
        for(Tile t : playerTiles)
        {
            if(t.finalHabitat != null && t.finalHabitat.getToken() == HabitatToken.ELK && !alreadyCountedTiles.contains(t))
            {
                ...
                //Keep counting in each direction for elk wildlifes
                if(matrix[x+1][y].finalHabitat != null && matrix[x+1][y].finalHabitat.getToken() == HabitatToken.ELK && !alreadyCountedTiles.contains(matrix[x+1][y]))
                {
                    while(matrix[x+1][y].finalHabitat != null && matrix[x+1][y].finalHabitat.getToken() == HabitatToken.ELK && !alreadyCountedTiles.contains(matrix[x+1][y]))
                    {
                        alreadyCountedTiles.add(matrix[x+1][y]);
                        count++;
                        x += 1;
                ...
                lineCount.add(count);
                count = 0;
                if(matrix[x][y+1].finalHabitat != null && matrix[x][y+1].finalHabitat.getToken() == HabitatToken.ELK && !alreadyCountedTiles.contains(matrix[x][y+1]))
                {
                    while(matrix[x][y+1].finalHabitat != null && matrix[x][y+1].finalHabitat.getToken() == HabitatToken.ELK && !alreadyCountedTiles.contains(matrix[x][y+1]))
                    {
                        alreadyCountedTiles.add(matrix[x][y+1]);
                        count++;
                        y += 1;
                ...
                if(count > 1) lineCount.add(count);
            }
        }
        ...
        {
            if(line == 1) score += 2;
            else if(line == 2) score += 5;
            else if(line == 3) score += 9;
            else score += 12;
        }
    ...
    public int BearScoreCard(Tile[][] matrix, ArrayList<Tile> playerTiles) { //Unique pairs of bears
        ...
        {
            count = 0;
            if(t.finalHabitat != null && t.finalHabitat.getToken() == HabitatToken.BEAR && !alreadyCountedTiles.contains(t))
            {
                alreadyCountedTiles.add(t);
        ...
        if(score == 1) return 4;
        if(score == 2) return 11;
        if(score == 3) return 19;
        if(score == 4) return 27;
    ...
    public int HawkScoreCard(Tile[][] matrix, ArrayList<Tile> playerTiles) {
        ...
        for(Tile t : playerTiles)
        {
            if(t.finalHabitat != null)
            {
                ...
                {
                    if(t2.finalHabitat != null && t2.finalHabitat.getToken() == HabitatToken.HAWK) alreadyCountedTiles.add(t2);
                }
            }
        }
        ...
        else if (score == 3) return 8;
        else if (score == 4) return 11;
        else if (score == 5) return 14;
        else if (score == 6) return 18;
        else if (score == 7) return 22;
        else return 26;
    }
