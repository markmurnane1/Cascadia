...
// board[t.getY() + 1][t.getX() + 1] = t.habitats.get(0).getColour() +
// t.habitats.get(0).getSymbol()
// + DisplayColour.RESET;
// board[t.getY() + 1][t.getX() + 2] = t.habitats.get(1).getColour() +
// t.habitats.get(1).getSymbol()
// + DisplayColour.RESET;
// board[t.getY() + 2][t.getX() + 1] = t.habitats.get(2).getColour() +
// t.habitats.get(2).getSymbol()
// + DisplayColour.RESET;
// }
...
// t.habitats.get(0).getSymbol()
// + DisplayColour.RESET;
// board[t.getY() + 2][t.getX() + 1] = t.habitats.get(1).getColour() +
// t.habitats.get(1).getSymbol()
// + DisplayColour.RESET;
// } else {
// board[t.getY() + 1][t.getX() + 1] = t.habitats.get(0).getColour() +
